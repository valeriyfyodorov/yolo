...
def post_process(input_image, outputs):
    ...
    for idx, i in enumerate(indices):
        ...
        # recognize_image(input_image[top:top+height,
        #                 left:left+width], f"{idx:05d}.jpg")
        recognize_image(input_image[cropped_top:cropped_bottom,
                        cropped_left:cropped_right], f"{idx:05d}.jpg")

    return output_img


def recognize_image(crop_img, file_name="01.jpg"):
